...
public class eliminarProducto extends javax.swing.JDialog {
     ...
     */
    public eliminarProducto(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("VTenda - Eliminar Producto");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                eliminarProducto dialog = new eliminarProducto(new javax.swing.JDialog(), true);
