 ...
 * @author DAW221
 */
public class errorCerrarTicketConContenido extends javax.swing.JDialog {

    /**
     * Creates new form errorCategoria
     */
    public errorCerrarTicketConContenido(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLInfo1.setText("Esta saliendo sin finalizar el Ticket en curso, el ticket");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(errorCerrarTicketConContenido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                errorCerrarTicketConContenido dialog = new errorCerrarTicketConContenido(new javax.swing.JDialog(), true);
