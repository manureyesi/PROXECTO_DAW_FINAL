 ...
 * @author DAW221
 */
public class errorCerrarTicketVacio extends javax.swing.JDialog {

    /**
     * Creates new form errorCategoria
     */
    public errorCerrarTicketVacio(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLInfo1.setText("Lo sentimos no se puede cerrar un Ticket si no");

        jLInfo2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLInfo2.setText("contiene ningun producto.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(errorCerrarTicketVacio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                errorCerrarTicketVacio dialog = new errorCerrarTicketVacio(new javax.swing.JDialog(), true);
